        ...
        <main className=' h-[93%] w-full overflow-y-auto'>
            <div className="h-[60%] w-full  flex flex-row  gap-8 mb-2">
                ...
                whileHover={{ scale: 1.1 }} transition={{ type: "spring", stiffness: 400, damping: 10 }}>
                    ...
                    <Image src={game} width={600}  alt="game"  className="h-full w-full rounded-xl object-fit" loading="lazy" />
                </motion.div>
            ...
            <div className="h-[60%] w-full flex flex-row gap-8 mb-2">
                <motion.div className="h-full w-[48%]  rounded-xl shadow-xl ml-2"
                whileHover={{ scale: 1.1 }} transition={{ type: "spring", stiffness: 300, damping: 10 }}>
                    <Image src={joke} width={600} height={110} alt="game" className="h-full w-full rounded-xl" loading="lazy" />
                </motion.div>
            ...
            <div className="h-[60%] w-full flex flex-row gap-8 mb-2">
                <motion.div className="h-full w-[48%]  rounded-xl shadow-xl ml-2"
                whileHover={{ scale: 1.1 }} transition={{ type: "spring", stiffness: 400, damping: 10 }}>
                    <Image src={weather} width={600} height={110} alt="game" className="h-full w-full rounded-xl" loading="lazy" />
                </motion.div>
            ...
            <div className="h-[60%] w-full flex flex-row gap-8 mb-2">
                <motion.div className="h-full w-[48%]  rounded-xl shadow-xl ml-2"
                whileHover={{ scale: 1.1 }} transition={{ type: "spring", stiffness: 400, damping: 10 }}>
                    <Image src={client} width={600} height={110} alt="game" className="h-full w-full rounded-xl" loading="lazy" />
                </motion.div>
